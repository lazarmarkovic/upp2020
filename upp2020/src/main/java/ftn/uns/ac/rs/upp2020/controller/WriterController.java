...
public class WriterController {
    ...
    @PostMapping(path = "/fix-transcript/{taskId}", produces = "application/json")
    public @ResponseBody ResponseEntity<?> fixTranscript(@RequestBody List<InputDataDTO> data, @PathVariable String taskId) {
